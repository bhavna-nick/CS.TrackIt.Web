...
@endif
                  <div class="x_content">
                   <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ url('profile-edit') }}" data-parsley-validate class="form-horizontal form-label-left">
...
<div class="file-upload">
	...
	function ValidatePhoneNo() {
			...
			return event.returnValue = '';
                  ...
                  <!------------------------------------------------------------->    
                    ...
                    <input id="fullname" class="form-control"  value="<?php echo $users[0]->SpouseContact; ?>" type="text" name="SpouseContact" onkeyup="return ValidatePhoneNo()" maxlength="10">                    
 ...
 <label for="fullname">Relation </label>
    ...
    <!-- Custom Theme Scripts --> <script src="{{ url('/') }}/bootstrap/theme/build/js/custom.min.js"></script>
